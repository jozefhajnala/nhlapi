context("nhl_url_player_season")

testthat::test_that(
  "nhl_url_player_season generates 1 regular season url for 1 player",
  testthat::expect_equal(
    nhl_url_player_season(8477474, "20172018"),
    paste0(
      baseurl,
...
testthat::test_that(
  "nhl_url_player_season generates 1 playoffs url for 1 player",
  testthat::expect_equal( # Patrick Roy, playoffs 95-96
    nhl_url_player_season(8451033L, "19951996", playoffs = TRUE),
    paste0(
      baseurl,
...
testthat::test_that(
  "nhl_url_player_season generates 2 playoff urls for 1 player",
  testthat::expect_equal(
...
testthat::test_that(
  "nhl_url_player_season generates 2 regular season urls for 2 players",
  testthat::expect_equal(
    nhl_url_player_season(c(8451101L, 8451102L), c("19951996", "19961997")),
    paste0(baseurl, c(
